...
We try to manage the required tasks for erinyoung/needles using GitHub issues, you probably came to this page when creating one.
...
To make the erinyoung/needles code and processing logic more understandable for new contributors and to ensure quality, we semi-standardise the way the code and other contributions are written.
...
- Open the repo in [Codespaces](https://github.com/erinyoung/needles/codespaces)
- Tools installed
  - nf-core
  - Nextflow
